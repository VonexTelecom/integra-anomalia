...
public interface AnomaliaRepository {
	...
	HashMap<FiltroEstatistica, ArrayList<EstatisticaDiscador>> findTipoEstatisticaSumarizada
			(LocalDateTime dataInicial, LocalDateTime dataFinal, String tipoEstatistica, Integer clienteId);
}
